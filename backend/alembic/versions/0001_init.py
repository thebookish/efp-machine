...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('content_event_eventId', sa.String, nullable=True),
        sa.Column('content_event_messages_0_message', sa.Text, nullable=True),
        sa.Column('content_event_messages_0_timestamp', sa.String, nullable=True),
        sa.Column('content_event_messages_0_sender_uuid', sa.String, nullable=True),
        ...
        # sa.Column('strategyDescription', sa.Text, nullable=True),
        # sa.Column('tradeable_Id', sa.String, nullable=True),
        sa.Column('contractId', sa.String, nullable=True),
        # sa.Column('contractName', sa.String, nullable=True),
        # sa.Column('strategyID_1', sa.String, nullable=True),
        ...
        sa.Column('b_client', sa.Text, nullable=True),
        sa.Column('o_client', sa.Text, nullable=True),
        sa.Column('bids', sa.Float, nullable=True),
        # sa.Column('indicatives', sa.Text, nullable=True),
        sa.Column('offers', sa.Float, nullable=True),
        sa.Column('pub_bid', sa.Text, nullable=True),
        sa.Column('pub_offer', sa.Text, nullable=True),
        sa.Column('alias', sa.String, nullable=True),
        sa.Column('legalEntityShortName', sa.String, nullable=True),
